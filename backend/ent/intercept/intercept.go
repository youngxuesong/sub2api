...
// The APIKeyRouteFailoverTargetFunc type is an adapter to allow the use of ordinary function as a Querier.
type APIKeyRouteFailoverTargetFunc func(context.Context, *ent.APIKeyRouteFailoverTargetQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f APIKeyRouteFailoverTargetFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.APIKeyRouteFailoverTargetQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.APIKeyRouteFailoverTargetQuery", q)
}

// The TraverseAPIKeyRouteFailoverTarget type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAPIKeyRouteFailoverTarget func(context.Context, *ent.APIKeyRouteFailoverTargetQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAPIKeyRouteFailoverTarget) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAPIKeyRouteFailoverTarget) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.APIKeyRouteFailoverTargetQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.APIKeyRouteFailoverTargetQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.APIKeyRouteFailoverTargetQuery:
		return &query[*ent.APIKeyRouteFailoverTargetQuery, predicate.APIKeyRouteFailoverTarget, apikeyroutefailovertarget.OrderOption]{typ: ent.TypeAPIKeyRouteFailoverTarget, tq: q}, nil
