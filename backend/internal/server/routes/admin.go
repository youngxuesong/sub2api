...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/route-failover", h.Admin.Group.GetRouteFailoverPolicy)
		groups.PUT("/:id/route-failover", h.Admin.Group.SaveRouteFailoverPolicy)
		groups.DELETE("/:id/route-failover", h.Admin.Group.DeleteRouteFailoverPolicy)
